...
export const EditStaffModal = ({ staff, onSave, onClose, doctors }) => {
  ...
  useEffect(() => {
    if (staff) {
      setFormData({
        name: staff.name,
        email: staff.email,
        role: staff.role === 'Nurse' ? 'Nurse' : 'Doctor',
        department: staff.department || '',
        phone: staff.phone || '',
        gender: staff.gender || 'Male',
        assigned_doctor_id: staff.assigned_doctor_id || '',
      });
    }
  }, [staff]);
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm() && staff) {
      onSave({
        ...staff,
        ...formData,
        role: formData.role === 'Nurse' ? 'Nurse' : 'Doctor'
      });
      onClose();
    }
  };
